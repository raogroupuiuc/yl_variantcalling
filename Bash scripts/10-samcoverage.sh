...
samtools coverage -q 30 -r pINT03-XYL123.gb:1-13,224 \
	--reference ../../genome/PO1f_plasmid.fna \
	-o ${line}_aligned.sorted.coverage.txt \
	 ${line}_aligned.sorted.bam

samtools depth -q 30 -r pINT03-XYL123.gb:1-13,224 \
        --reference ../../genome/PO1f_plasmid.fna \
        -o ${line}_aligned.sorted.depth.txt \
         ${line}_aligned.sorted.bam
